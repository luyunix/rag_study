...
- [ ] 我能构造包含 question、ground_truth、contexts、answer 的评测样本
- [ ] 我能说明模型与 Embedding 为什么都要传给 Ragas
- [ ] 我能从单条低分样本定位召回、排序、忠实性或回答完整性问题
- [ ] 我知道两道题只能验证链路，不能代表真实业务质量
- [ ] 我核对了本节完整 ASR 中的实战执行顺序
